...
// For instance:
// - Hero: "newsletterapp helps developers launch startups fast"
// - Problem Agitation: "Developers spend too much time adding features, get overwhelmed, and quit." (not about newsletterapp at all)
// - Features: "newsletterapp has user auth, Stripe, emails all set up for you"
const Problem = () => {
	return (
