...
const features = [
	{
		title: "Collect Subscriber Feedback",
		description:
			"Use your newsletter board to let subscribers submit feature requests.",
	...
	{
		title: "Prioritize Content Ideas",
		description:
			"Subscribers upvote content they want. You know what to write next.",
		styles: "md:col-span-2 bg-base-300 text-base-content",
		demo: (
			<div className="px-6 max-w-[600px] flex flex-col gap-4 overflow-hidden">
				{[
					{
						text: "Add a section for recent industry news",
						secondaryText: "Yes, write this! ✅",
						votes: 48,
						transition: "group-hover:-mt-36 group-hover:md:-mt-28 duration-500",
					},
					{
						text: "A new tutorial on using XYZ tool",
						secondaryText: "Maybe write this 🤔",
						votes: 12,
					},
					{
						text: "A feature on underrated tools",
						secondaryText: "But don't write that ❌",
						votes: 1,
					},
				].map((feature, i) => (
					<div
	...
	{
		title: "Your Brand, Your Newsletter",
		description: "Customize your newsletter with 7 themes.",
	...
	},
	{
		...
		description: "Subscribers can chat and discuss topics.",
