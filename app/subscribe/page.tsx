...
const Subscribe = () => {
   ...
   const handleSubmit = async (event: FormEvent) => {
      ...
      try {
         ...
         const response = await subscribe(email, username);
      ...
      <div className="h-screen w-full bg-neutral-950 relative flex flex-col items-center justify-center antialiased">
         <div className="max-w-2xl mx-auto p-4">
            ...
            <p className="text-neutral-500 max-w-lg mx-auto my-4 text-sm md:text-base text-center relative z-10">
               {`Stay updated with the latest from ${username}. Subscribe to my newsletter for insights, tips, and exclusive content.`}
            </p>
            ...
            <form className="flex items-center mt-4" onSubmit={handleSubmit}>
               ...
               />
               <button type="submit" className="btn mx-2 btn-lg cursor-pointer">
                  I'm in
